Create a function taking a positive integer as its parameter and returning a string c
ontaining the Roman Numeral representation of that integer.
...
def solution(number)
    # define hash which contains roman numeral equivalents
    roman_numerals = {
        1 => "I",
        5 = "V",
        10 => "X",
